...
inicio.style.display= "none";   //Garantir que o botão não seja visivel durante o jogo
//Que inicie a animação dos objetos do jogo
...
function jump (){ //Função para garantir a movimentação do personagem
        ...
        setTimeout(()=>{ //Com um períoddo de 500ms, retira a classe do personage,
...
const loop= setInterval(()=>{
    ...
    //Analisando se caso há uma colisão entre o personagem e a rocha
...
//Button para reiniciar a página
